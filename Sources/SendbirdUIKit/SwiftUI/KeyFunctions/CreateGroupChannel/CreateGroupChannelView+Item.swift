//
//  CreateGroupChannelView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.GroupChannel.CreateChannel {
    /// A struct that defines the header item of the CreateGroupChannel view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = CreateGroupChannelViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: CreateGroupChannelViewConverter.Header {
            get { SBViewConverterSet.CreateGroupChannel.header }
            set { SBViewConverterSet.CreateGroupChannel.header = newValue }
        }
    ...
    /// A struct that defines the list item of the CreateGroupChannel view.
    public struct ListItem: ViewItemProtocol {
        public typealias ViewContent = CreateGroupChannelViewConverter.List
        public typealias ListItemContent = ViewContent.TableView.RowView
        
        var viewConverter: CreateGroupChannelViewConverter.List {
            get { SBViewConverterSet.CreateGroupChannel.list }
            set { SBViewConverterSet.CreateGroupChannel.list = newValue }
        }
