...
// MARK: List
extension OpenOperatorListViewConverter {
...
extension OpenOperatorListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenOperatorListViewConverter.List.UpdatableVC
...
extension OpenOperatorListViewConverter.List.TableView {
...
extension OpenOperatorListViewConverter.List.TableView.RowView {
