//
//  SBUCreateOpenChannelModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBUCreateOpenChannelModule.Header {
    typealias ViewConverter = CreateOpenChannelViewConverter.Header
    
    var viewConverter: ViewConverter {
        SBViewConverterSet.CreateOpenChannel.header
    }
}
