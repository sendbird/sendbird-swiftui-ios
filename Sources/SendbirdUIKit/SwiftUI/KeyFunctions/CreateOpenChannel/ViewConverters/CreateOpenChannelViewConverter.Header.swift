...
// MARK: - Header
extension CreateOpenChannelViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUCreateOpenChannelModule.Header
...
extension CreateOpenChannelViewConverter.Header {
    /// A converter that updates the left bar button of a `SBUCreateOpenChannelViewController`.
    ...
    /// A converter that updates the right bar button of a `SBUCreateOpenChannelViewController`.
    ...
    /// A converter that updates the title view of a `SBUCreateOpenChannelViewController`.
