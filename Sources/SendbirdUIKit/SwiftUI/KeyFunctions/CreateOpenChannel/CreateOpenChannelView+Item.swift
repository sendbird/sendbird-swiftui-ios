//
//  CreateOpenChannelView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.OpenChannel.CreateChannel {
    /// A struct that defines the header item of the CreateOpenChannel view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = CreateOpenChannelViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: CreateOpenChannelViewConverter.Header {
            get { SBViewConverterSet.CreateOpenChannel.header }
            set { SBViewConverterSet.CreateOpenChannel.header = newValue }
        }
    ...
    /// A struct that defines the list item of the CreateOpenChannel view.
//    public struct ListItem: ViewItemProtocol {
//        public typealias ViewContent = CreateOpenChannelViewConverter.List
//        // TODO: 필요하면 구현 (↓↓ example ↓↓)
//        // public typealias ListItemContent = ViewContent.TableView.ChannelCell
//        
//        var viewConverter: CreateOpenChannelViewConverter.List {
//            get { SBViewConverterSet.CreateOpenChannel.list }
//            set { SBViewConverterSet.CreateOpenChannel.list = newValue }
//        }
//        
//        public init() {}
//        
