//
//  SBUGroupChannelPushSettingsModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBUGroupChannelPushSettingsModule.Header {
    typealias ViewConverter = GroupChannelPushSettingsViewConverter.Header
    
    var viewConverter: ViewConverter {
        SBViewConverterSet.GroupChannelPushSettings.header
    }
}
