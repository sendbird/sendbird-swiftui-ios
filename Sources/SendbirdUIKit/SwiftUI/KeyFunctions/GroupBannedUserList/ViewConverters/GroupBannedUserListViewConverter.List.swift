...
// MARK: List
extension GroupBannedUserListViewConverter {
...
extension GroupBannedUserListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = GroupBannedUserListViewConverter.List.UpdatableVC
...
extension GroupBannedUserListViewConverter.List.TableView {
...
extension GroupBannedUserListViewConverter.List.TableView.RowView {
