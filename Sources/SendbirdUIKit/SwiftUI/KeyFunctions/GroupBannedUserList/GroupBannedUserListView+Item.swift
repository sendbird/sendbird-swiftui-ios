//
//  GroupBannedUserListView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.GroupChannel.BannedUserList {
    /// A struct that defines the header item of the GroupBannedUserList view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = GroupBannedUserListViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: GroupBannedUserListViewConverter.Header {
            get { SBViewConverterSet.GroupBannedUserList.header }
            set { SBViewConverterSet.GroupBannedUserList.header = newValue }
        }
        ...
        public func leftView<Content: View>(
            ...
            copy.viewConverter.viewUpdateHandlers[.leftView] = { viewController in
                viewController.headerComponent?.applyViewConverterForBannedUser(.leftView)
            }
            return copy
        }
        ...
        public func rightView<Content: View>(
            ...
            copy.viewConverter.viewUpdateHandlers[.rightView] = { viewController in
                viewController.headerComponent?.applyViewConverterForBannedUser(.rightView)
            }
            return copy
        }
        ...
        public func titleView<Content: View>(
            ...
            copy.viewConverter.viewUpdateHandlers[.titleView] = { viewController in
                viewController.headerComponent?.applyViewConverterForBannedUser(.titleView)
            }
            return copy
        }
    }
    
    /// A struct that defines the list item of the GroupBannedUserList view.
    public struct ListItem: ViewItemProtocol {
        public typealias ViewContent = GroupBannedUserListViewConverter.List
        public typealias ListItemContent = ViewContent.TableView.RowView
        
        var viewConverter: GroupBannedUserListViewConverter.List {
            get { SBViewConverterSet.GroupBannedUserList.list }
            set { SBViewConverterSet.GroupBannedUserList.list = newValue }
        }
