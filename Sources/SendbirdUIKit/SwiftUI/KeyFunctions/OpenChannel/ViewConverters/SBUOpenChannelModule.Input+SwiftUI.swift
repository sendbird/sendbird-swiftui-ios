//
//  SBUOpenChannelModule.Input+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBUOpenChannelModule.Input {
    typealias ViewConverter = OpenChannelViewConverter.Input
    var viewConverter: ViewConverter {
        SBViewConverterSet.OpenChannel.input
    }
    ...
    func applyViewConverter(_ viewType: ViewConverter.ViewType) -> Bool {
        ...
        case .entireContent:
            ...
            guard let viewController = self.delegate as? SBUOpenChannelViewController
            else { return false }
