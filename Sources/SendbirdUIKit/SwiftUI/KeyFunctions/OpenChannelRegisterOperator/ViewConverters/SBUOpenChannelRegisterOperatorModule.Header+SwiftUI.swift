//
//  SBUOpenChannelRegisterOperatorModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
// FIXME: GroupChannel 쪽과 중복. 이후에 여기도 처리 필요
extension SBURegisterOperatorModule.Header {
    typealias ViewConverterForOpen = OpenChannelRegisterOperatorViewConverter.Header
    
    var viewConverterForOpen: ViewConverterForOpen {
        SBViewConverterSet.OpenChannelRegisterOperator.header
    }
}
