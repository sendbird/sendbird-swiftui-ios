...
extension OpenChannelRegisterOperatorViewConverter {
    public struct List: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBURegisterOperatorModule.List
...
extension OpenChannelRegisterOperatorViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenChannelRegisterOperatorViewConverter.List.UpdatableVC
...
//extension OpenChannelRegisterOperatorViewConverter.List.TableView {
...
//}
//
//extension OpenChannelRegisterOperatorViewConverter.List.TableView.ChannelCell {
