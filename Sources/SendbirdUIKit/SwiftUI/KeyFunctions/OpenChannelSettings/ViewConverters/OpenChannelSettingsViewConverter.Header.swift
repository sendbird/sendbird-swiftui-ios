...
// MARK: - Header
extension OpenChannelSettingsViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUOpenChannelSettingsModule.Header
        typealias UpdatableVC = SBUOpenChannelSettingsViewController
...
extension OpenChannelSettingsViewConverter.Header {
    /// A converter that updates the left bar button of a `SBUOpenChannelSettingsViewController`.
    ...
    /// A converter that updates the right bar button of a `SBUOpenChannelSettingsViewController`.
    ...
    /// A converter that updates the title view of a `SBUOpenChannelSettingsViewController`.
