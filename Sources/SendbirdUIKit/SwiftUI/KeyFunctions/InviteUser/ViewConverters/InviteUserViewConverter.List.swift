...
extension InviteUserViewConverter {
    public struct List: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUInviteUserModule.List
...
extension InviteUserViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = InviteUserViewConverter.List.UpdatableVC
...
extension InviteUserViewConverter.List.TableView {
...
extension InviteUserViewConverter.List.TableView.RowView {
