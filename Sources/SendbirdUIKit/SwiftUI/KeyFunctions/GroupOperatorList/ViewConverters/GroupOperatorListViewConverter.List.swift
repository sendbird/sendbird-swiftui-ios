...
// MARK: List
extension GroupOperatorListViewConverter {
...
extension GroupOperatorListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = GroupOperatorListViewConverter.List.UpdatableVC
...
extension GroupOperatorListViewConverter.List.TableView {
...
extension GroupOperatorListViewConverter.List.TableView.RowView {
