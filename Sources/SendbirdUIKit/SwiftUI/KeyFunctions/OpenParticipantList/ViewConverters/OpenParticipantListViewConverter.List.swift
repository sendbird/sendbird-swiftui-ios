...
// MARK: List
extension OpenParticipantListViewConverter {
...
extension OpenParticipantListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenParticipantListViewConverter.List.UpdatableVC
...
extension OpenParticipantListViewConverter.List.TableView {
...
extension OpenParticipantListViewConverter.List.TableView.RowView {
