...
extension OpenMutedParticipantListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenMutedParticipantListViewConverter.List.UpdatableVC
...
extension OpenMutedParticipantListViewConverter.List.TableView {
...
extension OpenMutedParticipantListViewConverter.List.TableView.RowView {
