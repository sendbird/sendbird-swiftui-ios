...
// MARK: List
extension GroupMutedMemberListViewConverter {
...
extension GroupMutedMemberListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = GroupMutedMemberListViewConverter.List.UpdatableVC
...
extension GroupMutedMemberListViewConverter.List.TableView {
    public struct RowView: ViewConverterProtocol {
        ...
        var operatorStateView = OperatorStateView()
        ...
        func applyViewUpdates(to viewController: UpdatableVC, includeSubDepth: Bool) {
            ...
            self.operatorStateView.applyViewUpdates(to: viewController, includeSubDepth: includeSubDepth)
        }
    }
}

extension GroupMutedMemberListViewConverter.List.TableView.RowView {
    ...
    public struct OperatorStateView: ViewConverterProtocol {
        // MARK: ViewType
        enum ViewType: ViewTypeEnum {
            case entireContent
        }
