//
//  SBUGroupChannelRegisterOperatorModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBURegisterOperatorModule.Header {
    typealias ViewConverter = GroupChannelRegisterOperatorViewConverter.Header
    
    var viewConverter: ViewConverter {
        SBViewConverterSet.GroupChannelRegisterOperator.header
    }
}
