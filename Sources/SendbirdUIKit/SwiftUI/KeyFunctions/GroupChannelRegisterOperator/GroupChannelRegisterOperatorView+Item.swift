//
//  GroupChannelRegisterOperatorView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.GroupChannel.RegisterOperator {
    /// A struct that defines the header item of the GroupChannelRegisterOperator view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = GroupChannelRegisterOperatorViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: GroupChannelRegisterOperatorViewConverter.Header {
            get { SBViewConverterSet.GroupChannelRegisterOperator.header }
            set { SBViewConverterSet.GroupChannelRegisterOperator.header = newValue }
        }
    ...
    /// A struct that defines the list item of the GroupChannelRegisterOperator view.
    public struct ListItem: ViewItemProtocol {
        public typealias ViewContent = GroupChannelRegisterOperatorViewConverter.List
        // TODO: 필요하면 구현 (↓↓ example ↓↓)
        // public typealias ListItemContent = ViewContent.TableView.ChannelCell
        
        var viewConverter: GroupChannelRegisterOperatorViewConverter.List {
            get { SBViewConverterSet.GroupChannelRegisterOperator.list }
            set { SBViewConverterSet.GroupChannelRegisterOperator.list = newValue }
        }
