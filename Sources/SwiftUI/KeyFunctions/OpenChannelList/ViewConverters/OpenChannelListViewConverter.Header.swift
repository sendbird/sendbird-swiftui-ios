...
extension OpenChannelListViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUOpenChannelListModule.Header
...
extension OpenChannelListViewConverter.Header {
    /// A converter that updates the left bar button of a `SBUOpenChannelListViewController`.
    ...
    /// A converter that updates the right bar button of a `SBUOpenChannelListViewController`.
    ...
    /// A converter that updates the title view of a `SBUOpenChannelListViewController`.
