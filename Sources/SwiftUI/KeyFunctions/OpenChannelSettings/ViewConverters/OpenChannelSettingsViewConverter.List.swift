...
extension OpenChannelSettingsViewConverter {
    public struct List: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUOpenChannelSettingsModule.List
...
extension OpenChannelSettingsViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenChannelSettingsViewConverter.List.UpdatableVC
...
//extension OpenChannelSettingsViewConverter.List.TableView {
...
//}
//
//extension OpenChannelSettingsViewConverter.List.TableView.ChannelCell {
