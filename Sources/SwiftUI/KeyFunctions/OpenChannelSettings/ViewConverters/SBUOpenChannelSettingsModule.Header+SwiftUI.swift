//
//  SBUOpenChannelSettingsModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBUOpenChannelSettingsModule.Header {
    typealias ViewConverter = OpenChannelSettingsViewConverter.Header
    
    var viewConverter: ViewConverter {
        SBViewConverterSet.OpenChannelSettings.header
    }
}
