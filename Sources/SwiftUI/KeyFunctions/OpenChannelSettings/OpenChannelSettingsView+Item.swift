//
//  OpenChannelSettingsView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.OpenChannel.Settings {
    /// A struct that defines the header item of the OpenChannelSettings view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = OpenChannelSettingsViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: OpenChannelSettingsViewConverter.Header {
            get { SBViewConverterSet.OpenChannelSettings.header }
            set { SBViewConverterSet.OpenChannelSettings.header = newValue }
        }
    ...
    /// A struct that defines the list item of the OpenChannelSettings view.
    public struct ListItem: ViewItemProtocol {
        public typealias ViewContent = OpenChannelSettingsViewConverter.List
        // TODO: 필요하면 구현 (↓↓ example ↓↓)
        // public typealias ListItemContent = ViewContent.TableView.ChannelCell
        
        var viewConverter: OpenChannelSettingsViewConverter.List {
            get { SBViewConverterSet.OpenChannelSettings.list }
            set { SBViewConverterSet.OpenChannelSettings.list = newValue }
        }
