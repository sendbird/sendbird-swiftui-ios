...
extension CreateGroupChannelViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUCreateChannelModule.Header
...
extension CreateGroupChannelViewConverter.Header {
    /// A converter that updates the left bar button of a `SBUCreateChannelViewController`.
