...
extension OpenModerationsViewConverter {
    public struct List: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUModerationsModule.List
...
extension OpenModerationsViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = OpenModerationsViewConverter.List.UpdatableVC
...
//extension OpenModerationsViewConverter.List.TableView {
...
//}
//
//extension OpenModerationsViewConverter.List.TableView.ChannelCell {
