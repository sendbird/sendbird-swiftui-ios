...
// MARK: List
extension GroupMemberListViewConverter {
...
extension GroupMemberListViewConverter.List {
    public struct TableView: ViewConverterProtocol {
        // MARK: TypeAlias
        typealias UpdatableVC = GroupMemberListViewConverter.List.UpdatableVC
...
extension GroupMemberListViewConverter.List.TableView {
...
extension GroupMemberListViewConverter.List.TableView.RowView {
