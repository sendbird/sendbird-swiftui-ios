//
//  GroupMemberListViewProvider.swift
//  SendbirdUIKit
//
...
/// Event handlers for the Group Member List view.
public struct GroupMemberListViewEventHandlers {
...
// MARK: - GroupMemberListViewProvider
/// A provider that manages data and state for the Group Member List view.
public class GroupMemberListViewProvider: SendbirdUIProvider {
    ...
    var eventHandlers = GroupMemberListViewEventHandlers()
...
extension GroupMemberListViewProvider: UserListViewEventDelegate {
...
extension GroupMemberListViewProvider: SBUUserListViewModelDelegate {
...
extension GroupMemberListViewProvider: SBUCommonViewModelDelegate {
