...
extension GroupChannelPushSettingsViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBUGroupChannelPushSettingsModule.Header
        ...
        public struct ViewConfig: ViewConfigurations {
            ...
            var currentTriggerOption: GroupChannelPushTriggerOption
        }
...
extension GroupChannelPushSettingsViewConverter.Header {
    /// A converter that updates the left bar button of a `SBUGroupChannelPushSettingsViewController`.
