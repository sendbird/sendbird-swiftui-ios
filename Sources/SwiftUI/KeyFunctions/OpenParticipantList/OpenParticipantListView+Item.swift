//
//  OpenParticipantListView+Item.swift
//  SendbirdSwiftUI
//
...
extension Sendbird.View.OpenChannel.MemberList {
    /// A struct that defines the header item of the OpenParticipantList view.
    public struct HeaderItem: ViewItemProtocol {
        public typealias ViewContent = OpenParticipantListViewConverter.Header
        public typealias HeaderContent = ViewContent

        var viewConverter: OpenParticipantListViewConverter.Header {
            get { SBViewConverterSet.OpenParticipantList.header }
            set { SBViewConverterSet.OpenParticipantList.header = newValue }
        }
    ...
    /// A struct that defines the list item of the OpenParticipantList view.
    public struct ListItem: ViewItemProtocol {
        public typealias ViewContent = OpenParticipantListViewConverter.List
        public typealias ListItemContent = ViewContent.TableView.RowView
        
        var viewConverter: OpenParticipantListViewConverter.List {
            get { SBViewConverterSet.OpenParticipantList.list }
            set { SBViewConverterSet.OpenParticipantList.list = newValue }
        }
