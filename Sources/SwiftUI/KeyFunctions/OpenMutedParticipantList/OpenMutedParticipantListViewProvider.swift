...
/// Event handlers for the open muted participant list view.
public struct OpenMutedParticipantListViewEventHandlers { // swiftlint:disable:this type_name
...
/// A provider that manages data and state for the Open Muted Participant List view.
