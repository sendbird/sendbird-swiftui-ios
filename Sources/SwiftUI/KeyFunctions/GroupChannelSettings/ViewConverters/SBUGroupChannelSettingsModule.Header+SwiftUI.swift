//
//  SBUGroupChannelSettingsModule.Header+SwiftUI.swift
//  SendbirdSwiftUI
//
...
extension SBUGroupChannelSettingsModule.Header {
    typealias ViewConverter = GroupChannelSettingsViewConverter.Header
    
    var viewConverter: ViewConverter {
        SBViewConverterSet.GroupChannelSettings.header
    }
}
