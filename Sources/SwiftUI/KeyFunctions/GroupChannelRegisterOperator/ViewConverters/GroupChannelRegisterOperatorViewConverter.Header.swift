...
// MARK: - Header
extension GroupChannelRegisterOperatorViewConverter {
    public struct Header: ViewConverterProtocol {
        // MARK: TypeAlias
        public typealias ContentBaseArg = SBURegisterOperatorModule.Header
...
extension GroupChannelRegisterOperatorViewConverter.Header {
    /// A converter that updates the left bar button of a `SBURegisterOperatorViewController`.
    ...
    /// A converter that updates the right bar button of a `SBURegisterOperatorViewController`.
    ...
    /// A converter that updates the title view of a `SBURegisterOperatorViewController`.
