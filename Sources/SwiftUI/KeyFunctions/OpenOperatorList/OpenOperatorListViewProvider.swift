//
//  OpenOperatorListViewProvider.swift
//  SendbirdUIKit
//
...
/// Event handlers for the Open Operator List view.
public struct OpenOperatorListViewEventHandlers {
...
// MARK: - OpenOperatorListViewProvider
/// A provider that manages data and state for the Open Operator List view.
public class OpenOperatorListViewProvider: SendbirdUIProvider {
    ...
    var eventHandlers = OpenOperatorListViewEventHandlers()
...
extension OpenOperatorListViewProvider: UserListViewEventDelegate {
...
extension OpenOperatorListViewProvider: SBUUserListViewModelDelegate {
...
extension OpenOperatorListViewProvider: SBUCommonViewModelDelegate {
